...
<div className="mockup-wrapper floating-mockup">
  ...
  <section id="faq" className="faq-section">
    <div className="faq-container">
      ...
      <details className="faq-item">
        ...
        <p>
          Nexun uses AI to evaluate ATS compatibility, keywords,
      ...
      <details className="faq-item">
        ...
        <p>
          Your resume text and analysis results are securely stored
          and linked to your account so you can revisit your results
          later.
        </p>
